  ...
  constructor(props) {
    ...
    this.state = {
      ...
      riddles: [
        {
          id: "Rowan tree",
          question: "By the gates to Morley Park…",
          options: ["Robin", "Rabbit", "Rowan tree"],
          answer: "Rowan tree",
        },
        {
          id: "Toad",
          question: "Not too far from the pond in the meadow…",
          options: ["Tadpole", "Toad", "Tawny owl"],
          answer: "Toad",
        },
        {
          id: "Starling",
          question: "In the woods near an entrance gate...",
          options: ["Sparrow", "Starling", "Scout hut"],
          answer: "Starling",
        },
        {
          id: "Cuckoo",
          question: "In the woods again but under a signpost...",
          options: ["Cuckoo", "Chaffinch", "Crow"],
          answer: "Cuckoo",
        },
        {
          id: "Mouse",
          question: "In a corner of the wildflower meadow...",
          options: ["Mouse", "Meadow", "Mud"],
          answer: "Mouse",
        },
        {
          id: "Holly",
          question: "Near some steps...",
          options: ["Heron", "Hawthorn", "Holly"],
          answer: "Holly",
        },
        {
          id: "Stinging nettles",
          question: "On a sloping path...",
          options: ["Stinging nettles", "Steps", "Signpost"],
          answer: "Stinging nettles",
        },
        {
          id: "Ivy",
          question: "From here, the scout hut can be seen...",
          options: ["Information board", "Ivy", "Insects"],
          answer: "Ivy",
        },
        {
          id: "Acorn",
          question: "Under an oak tree...",
